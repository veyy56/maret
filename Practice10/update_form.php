...
<html lang="en">
  ...
  <body class="bg-light">
    <div class="container">
      <div class="py-5 text-center">
        <h2>Form Data Mahasiswa IT Telkom Purwokerto </h2>
      </div>
      ...
      <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
          <h4 class="d-flex justify-content-between align-items-center mb-3">
           <span class="text-muted">Data Mahasiswa</span>
            <span class=""></span>
            <?php
            print_r($data_mahasiswa->num_rows);
            ?>
          </h4>
          <?php
       ...
       _lengkap'] ?>" required>
        ...
        <input type="text" class="formcontrol" id="alamat" name="alamat" value="<?php echo $data_select_mahasiswa['alamat'] ?>" req
       uired>
        </div>
        <div class="mb-3">
        ...
        ?>
        <option <?php echo $is_selected ?> value="<?php echo $value['kelas_id'] ?>"><?php ech
       o $value['nama'] ?></option>
        <?php
        }
        ?>
  ...
  <footer class="my-5 pt-5 text-muted text-center text-small">
    <p class="mb-1">&copy; 21102173  Dian Ristey Ajeng Pramono</p>
